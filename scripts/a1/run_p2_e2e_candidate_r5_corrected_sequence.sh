...
CONFIG=$ROOT/configs/a1/p2_e2e_candidate_r5_corrected_20260909
RUN_ROOT=/data/data2/TuJiajun/A1-smoke-r4/p2_e2e_candidate_r5_corrected_20260909
...
run_one() {
  ...
  local run="$RUN_ROOT/${name}_seed260829_5ep"
